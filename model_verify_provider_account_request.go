...
type _VerifyProviderAccountRequest VerifyProviderAccountRequest
...
func (o *VerifyProviderAccountRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVerifyProviderAccountRequest := _VerifyProviderAccountRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerifyProviderAccountRequest)

	if err != nil {
		return err
	}

	*o = VerifyProviderAccountRequest(varVerifyProviderAccountRequest)
