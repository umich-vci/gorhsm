...
*/
func (a *SubscriptionApiService) ListSubContentSets(ctx _context.Context, subscriptionNumber string, localVarOptionals *ListSubContentSetsOpts) (InlineResponse20010, *_nethttp.Response, error) {
	var (
...
*/
func (a *SubscriptionApiService) ListSubSystems(ctx _context.Context, subscriptionNumber string, localVarOptionals *ListSubSystemsOpts) (InlineResponse20011, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *SubscriptionApiService) ListSubscriptions(ctx _context.Context, localVarOptionals *ListSubscriptionsOpts) (InlineResponse2009, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
