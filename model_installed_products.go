...
// checks if the InstalledProducts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstalledProducts{}
...
func (o InstalledProducts) ToMap() (map[string]interface{}, error) {
