...
// checks if the ImageInContentSet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageInContentSet{}
...
func (o ImageInContentSet) ToMap() (map[string]interface{}, error) {
