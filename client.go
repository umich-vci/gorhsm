...
// APIClient manages communication with the RHSM-API API v1.313.0
...
type APIClient struct {
	...
	CloudaccessApi *CloudaccessApiService

	ErrataApi *ErrataApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.CloudaccessApi = (*CloudaccessApiService)(&c.common)
	c.ErrataApi = (*ErrataApiService)(&c.common)
