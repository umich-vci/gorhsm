...
// checks if the GoldImageStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoldImageStatus{}
...
func (o GoldImageStatus) ToMap() (map[string]interface{}, error) {
