...
// checks if the SystemListMock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemListMock{}
...
func (o SystemListMock) ToMap() (map[string]interface{}, error) {
