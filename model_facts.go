...
// checks if the Facts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Facts{}
...
func (o Facts) ToMap() (map[string]interface{}, error) {
