...
### NewPackageForSystemWithDefaults
...
GetErrataCount returns the ErrataCount field if non-nil, zero value otherwise.

### GetErrataCountOk

`func (o *PackageForSystem) GetErrataCountOk() (*int32, bool)`

GetErrataCountOk returns a tuple with the ErrataCount field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetErrataCount sets ErrataCount field to given value.
