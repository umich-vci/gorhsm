...
// checks if the CheckOrgSCACapability200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckOrgSCACapability200Response{}
...
func (o CheckOrgSCACapability200Response) ToMap() (map[string]interface{}, error) {
