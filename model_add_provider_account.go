...
// checks if the AddProviderAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddProviderAccount{}
...
func (o AddProviderAccount) ToMap() (map[string]interface{}, error) {
