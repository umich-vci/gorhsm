...
// checks if the PoolsListMock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolsListMock{}
...
func (o PoolsListMock) ToMap() (map[string]interface{}, error) {
