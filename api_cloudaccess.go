...
func (r ApiListEnabledCloudAccessProvidersRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *CloudaccessApiService) ListEnabledCloudAccessProvidersExecute(r ApiListEnabledCloudAccessProvidersRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r ApiUpdateProviderAccountDeprecatedRequest) Execute() (*http.Response, error) {
...
Deprecated
*/
func (a *CloudaccessApiService) UpdateProviderAccountDeprecated(ctx context.Context, providerShortName string) ApiUpdateProviderAccountDeprecatedRequest {
	return ApiUpdateProviderAccountDeprecatedRequest{
		ApiService:        a,
		ctx:               ctx,
		providerShortName: providerShortName,
...
// Execute executes the request
// Deprecated
func (a *CloudaccessApiService) UpdateProviderAccountDeprecatedExecute(r ApiUpdateProviderAccountDeprecatedRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPut
		localVarPostBody   interface{}
		formFiles          []formFile
