...
func (r ApiAddProviderAccountsRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *CloudaccessApiService) AddProviderAccounts(ctx _context.Context, providerShortName string) ApiAddProviderAccountsRequest {
	return ApiAddProviderAccountsRequest{
		ApiService:        a,
		ctx:               ctx,
...
func (a *CloudaccessApiService) AddProviderAccountsExecute(r ApiAddProviderAccountsRequest) (*_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"ProviderShortName"+"}", _neturl.PathEscape(parameterToString(r.providerShortName, "")), -1)
...
type ApiEnableGoldImagesRequest struct {
	...
	ApiService        *CloudaccessApiService
	providerShortName string
	goldImages        *InlineObject5
}

func (r ApiEnableGoldImagesRequest) GoldImages(goldImages InlineObject5) ApiEnableGoldImagesRequest {
	r.goldImages = &goldImages
	return r
}

func (r ApiEnableGoldImagesRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *CloudaccessApiService) EnableGoldImages(ctx _context.Context, providerShortName string) ApiEnableGoldImagesRequest {
	return ApiEnableGoldImagesRequest{
		ApiService:        a,
		ctx:               ctx,
		providerShortName: providerShortName,
...
// Execute executes the request
func (a *CloudaccessApiService) EnableGoldImagesExecute(r ApiEnableGoldImagesRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiListEnabledCloudAccessProvidersRequest) Execute() (InlineResponse2006, *_nethttp.Response, error) {
...
*/
func (a *CloudaccessApiService) ListEnabledCloudAccessProviders(ctx _context.Context) ApiListEnabledCloudAccessProvidersRequest {
	return ApiListEnabledCloudAccessProvidersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CloudaccessApiService) ListEnabledCloudAccessProvidersExecute(r ApiListEnabledCloudAccessProvidersRequest) (InlineResponse2006, *_nethttp.Response, error) {
	var (
...
type ApiRemoveProviderAccountRequest struct {
	...
	ApiService        *CloudaccessApiService
	providerShortName string
	account           *InlineObject2
}

func (r ApiRemoveProviderAccountRequest) Account(account InlineObject2) ApiRemoveProviderAccountRequest {
	r.account = &account
	return r
}

func (r ApiRemoveProviderAccountRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *CloudaccessApiService) RemoveProviderAccount(ctx _context.Context, providerShortName string) ApiRemoveProviderAccountRequest {
	return ApiRemoveProviderAccountRequest{
		ApiService:        a,
		ctx:               ctx,
		providerShortName: providerShortName,
...
// Execute executes the request
func (a *CloudaccessApiService) RemoveProviderAccountExecute(r ApiRemoveProviderAccountRequest) (*_nethttp.Response, error) {
	var (
...
type ApiUpdateProviderAccountRequest struct {
	...
	providerShortName string
	accountID         string
	account           *InlineObject3
}

func (r ApiUpdateProviderAccountRequest) Account(account InlineObject3) ApiUpdateProviderAccountRequest {
	r.account = &account
	return r
}

func (r ApiUpdateProviderAccountRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *CloudaccessApiService) UpdateProviderAccount(ctx _context.Context, providerShortName string, accountID string) ApiUpdateProviderAccountRequest {
	return ApiUpdateProviderAccountRequest{
		ApiService:        a,
		ctx:               ctx,
		providerShortName: providerShortName,
...
// Execute executes the request
func (a *CloudaccessApiService) UpdateProviderAccountExecute(r ApiUpdateProviderAccountRequest) (*_nethttp.Response, error) {
	var (
...
type ApiUpdateProviderAccountDeprecatedRequest struct {
	ctx               _context.Context
	ApiService        *CloudaccessApiService
	providerShortName string
	account           *InlineObject1
}

func (r ApiUpdateProviderAccountDeprecatedRequest) Account(account InlineObject1) ApiUpdateProviderAccountDeprecatedRequest {
	r.account = &account
	return r
}

func (r ApiUpdateProviderAccountDeprecatedRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.UpdateProviderAccountDeprecatedExecute(r)
}

/*
UpdateProviderAccountDeprecated Update provider account
...
Updates the account nickname for a currently-enabled provider account. You can find a list of currently-enabled provider accounts and provider short names from the `/v1/cloud_access_providers/enabled` endpoint.
 ...
 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param providerShortName
 @return ApiUpdateProviderAccountDeprecatedRequest

Deprecated
*/
func (a *CloudaccessApiService) UpdateProviderAccountDeprecated(ctx _context.Context, providerShortName string) ApiUpdateProviderAccountDeprecatedRequest {
	return ApiUpdateProviderAccountDeprecatedRequest{
		ApiService:        a,
		ctx:               ctx,
		providerShortName: providerShortName,
...
// Execute executes the request
// Deprecated
func (a *CloudaccessApiService) UpdateProviderAccountDeprecatedExecute(r ApiUpdateProviderAccountDeprecatedRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudaccessApiService.UpdateProviderAccountDeprecated")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cloud_access_providers/{ProviderShortName}/account"
	localVarPath = strings.Replace(localVarPath, "{"+"ProviderShortName"+"}", _neturl.PathEscape(parameterToString(r.providerShortName, "")), -1)
...
type ApiVerifyProviderAccountRequest struct {
	...
	providerShortName string
	accountID         string
	account           *InlineObject4
}

func (r ApiVerifyProviderAccountRequest) Account(account InlineObject4) ApiVerifyProviderAccountRequest {
	r.account = &account
	return r
}

func (r ApiVerifyProviderAccountRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *CloudaccessApiService) VerifyProviderAccount(ctx _context.Context, providerShortName string, accountID string) ApiVerifyProviderAccountRequest {
	return ApiVerifyProviderAccountRequest{
		ApiService:        a,
		ctx:               ctx,
		providerShortName: providerShortName,
...
// Execute executes the request
func (a *CloudaccessApiService) VerifyProviderAccountExecute(r ApiVerifyProviderAccountRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
