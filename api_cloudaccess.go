...
type ApiEnableGoldImagesRequest struct {
	...
	ApiService        *CloudaccessApiService
	providerShortName string
	goldImages        *InlineObject4
}

func (r ApiEnableGoldImagesRequest) GoldImages(goldImages InlineObject4) ApiEnableGoldImagesRequest {
...
func (r ApiRemoveProviderAccountRequest) Account(account InlineObject1) ApiRemoveProviderAccountRequest {
	r.account = &account
	return r
}
...
func (r ApiUpdateProviderAccountRequest) Account(account InlineObject2) ApiUpdateProviderAccountRequest {
	r.account = &account
	return r
}
...
type ApiUpdateProviderAccountDeprecatedRequest struct {
	...
	ApiService        *CloudaccessApiService
	providerShortName string
	account           *InlineObject
}

func (r ApiUpdateProviderAccountDeprecatedRequest) Account(account InlineObject) ApiUpdateProviderAccountDeprecatedRequest {
	r.account = &account
	return r
}
...
func (r ApiVerifyProviderAccountRequest) Account(account InlineObject3) ApiVerifyProviderAccountRequest {
	r.account = &account
	return r
}
