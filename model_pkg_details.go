...
// checks if the PkgDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PkgDetails{}
...
func (o PkgDetails) ToMap() (map[string]interface{}, error) {
